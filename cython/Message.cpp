...
#define __PYX_HAVE__Message
#define __PYX_HAVE_API__Message
/* Early includes */
#include <string.h>
#include <string_view>
#include "ios"
...
#define __Pyx_MODULE_NAME "Message"
extern int __pyx_module_is_main_Message;
int __pyx_module_is_main_Message = 0;
...
__Pyx_RefNannySetupContext("PyInit_Message", 0);
  ...
  if (__pyx_module_is_main_Message) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Message")) {
      if (unlikely((PyDict_SetItemString(modules, "Message", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init Message", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init Message");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
